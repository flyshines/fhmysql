package com.fh.controller.administrator.system.head;
...
public class HeadController extends BaseController {
	...
	public ModelAndView editEmail() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("administrator/system/head/edit_email");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView goSendSms() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("administrator/system/head/send_sms");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView goSendEmail() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("administrator/system/head/send_email");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView goEditEmail() throws Exception{
		...
		mv.setViewName("administrator/system/head/sys_edit");
		mv.addObject("pd", pd);
	...
	public ModelAndView saveSys() throws Exception{
		...
		mv.addObject("msg","OK");
		mv.setViewName("administrator/save_result");
		return mv;
	}
	...
	public ModelAndView goProductCode() throws Exception{
		ModelAndView mv = this.getModelAndView();
		mv.setViewName("administrator/system/head/productCode");
		return mv;
	}
