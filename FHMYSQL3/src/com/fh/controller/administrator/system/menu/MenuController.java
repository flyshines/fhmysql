package com.fh.controller.administrator.system.menu;
...
public class MenuController extends BaseController {
	...
	public ModelAndView list()throws Exception{
		...
		try{
			...
			mv.setViewName("administrator/system/menu/menu_list");
		} catch(Exception e){
	...
	public ModelAndView toAdd()throws Exception{
		...
		try{
			List<Menu> menuList = menuService.listAllParentMenu();
			mv.addObject("menuList", menuList);
			mv.setViewName("administrator/system/menu/menu_add");
		} catch(Exception e){
			logger.error(e.toString(), e);
		}
		return mv;
	...
	public ModelAndView toEdit(String MENU_ID)throws Exception{
		...
		try{
			...
			mv.addObject("menuList", menuList);
			mv.addObject("pd", pd);
			mv.setViewName("administrator/system/menu/menu_edit");
		} catch(Exception e){
			logger.error(e.toString(), e);
		}
		return mv;
	...
	public ModelAndView toEditicon(String MENU_ID)throws Exception{
		...
		try{
			...
			pd.put("MENU_ID",MENU_ID);
			mv.addObject("pd", pd);
			mv.setViewName("administrator/system/menu/menu_icon");
		} catch(Exception e){
			logger.error(e.toString(), e);
		}
		return mv;
