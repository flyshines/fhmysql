package com.fh.controller.administrator.system.dictionaries;
...
public class DictionariesController extends BaseController {
	...
	public ModelAndView list(Page page)throws Exception{
		...
		mv.setViewName("administrator/system/dictionaries/zd_list");
	...
	public ModelAndView toAdd(Page page){
		...
		try{
			pd = this.getPageData();
			mv.setViewName("administrator/system/dictionaries/zd_edit");
			mv.addObject("pd", pd);
		} catch(Exception e){
			logger.error(e.toString(), e);
		}
