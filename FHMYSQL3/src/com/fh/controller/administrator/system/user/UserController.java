package com.fh.controller.administrator.system.user;
...
public class UserController extends BaseController {
	...
	public ModelAndView goEditU() throws Exception{
		...
		mv.setViewName("administrator/system/user/user_edit");
	...
	public ModelAndView listUsers(Page page)throws Exception{
		...
		mv.setViewName("administrator/system/user/user_list");
	...
	public ModelAndView listtabUsers(Page page)throws Exception{
		...
		mv.setViewName("administrator/system/user/user_tb_list");
		mv.addObject("userList", userList);
		mv.addObject("pd", pd);
		mv.addObject(Const.SESSION_QX,this.getHC());	//按钮权限
		return mv;
	...
	public ModelAndView goUploadExcel()throws Exception{
		ModelAndView mv = this.getModelAndView();
		mv.setViewName("administrator/system/user/uploadexcel");
		return mv;
	}
