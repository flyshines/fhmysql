package com.fh.controller.administrator.system.tools;
...
public class ToolController extends BaseController {
	...
	public ModelAndView editEmail() throws Exception{
		...
		pd = this.getPageData();
		mv.setViewName("administrator/system/tools/interfaceTest");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView goSendEmail() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("administrator/system/tools/email");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView goTwoDimensionCode() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("administrator/system/tools/twoDimensionCode");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView ztree() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("administrator/system/tools/ztree");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView map() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("administrator/system/tools/map");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView mapXY() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("administrator/system/tools/mapXY");
		mv.addObject("pd", pd);
		return mv;
	}
