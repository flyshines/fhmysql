package com.fh.controller.administrator.system.login;
...
public class LoginController extends BaseController {
	...
	public ModelAndView toLogin()throws Exception{
		...
		mv.setViewName("administrator/system/admin/login");
		mv.addObject("pd",pd);
		return mv;
	}
	...
	public ModelAndView login_index(@PathVariable("changeMenu") String changeMenu){
		...
		try{
			...
			if (user != null) {
				...
				mv.setViewName("administrator/system/admin/index");
				mv.addObject("user", user);
				mv.addObject("menuList", menuList);
			}else {
				mv.setViewName("administrator/system/admin/login");//session失效后跳转登录页面
			}
	...
	public String tab(){
		return "administrator/system/admin/tab";
	}
	...
	public String defaultPage(){
		return "administrator/system/admin/default";
	}
