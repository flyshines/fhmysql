package com.fh.controller.administrator.system.role;
...
public class RoleController extends BaseController {
	...
	public ModelAndView list(Page page)throws Exception{
			...
			mv.setViewName("administrator/system/role/role_list");
	...
	public ModelAndView toAdd(Page page){
		...
		try{
			pd = this.getPageData();
			mv.setViewName("administrator/system/role/role_add");
			mv.addObject("pd", pd);
		} catch(Exception e){
			logger.error(e.toString(), e);
		}
	...
	public ModelAndView toEdit( String ROLE_ID )throws Exception{
		...
		try{
			...
			mv.setViewName("administrator/system/role/role_edit");
			mv.addObject("pd", pd);
		} catch(Exception e){
			logger.error(e.toString(), e);
		}
	...
	public String auth(@RequestParam String ROLE_ID,Model model)throws Exception{
		...
		return "administrator/authorization";
	}
	...
	public ModelAndView button(@RequestParam String ROLE_ID,@RequestParam String msg,Model model)throws Exception{
		...
		mv.setViewName("administrator/system/role/role_button");
		return mv;
	}
