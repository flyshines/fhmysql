package com.fh.controller.administrator.system.appuser;
...
public class AppuserController extends BaseController {
	...
	public ModelAndView goEditU(){
		...
		try {
			...
			mv.setViewName("administrator/system/appuser/appuser_edit");
	...
	public ModelAndView listUsers(Page page){
		...
		try{
			...
			mv.setViewName("administrator/system/appuser/appuser_list");
