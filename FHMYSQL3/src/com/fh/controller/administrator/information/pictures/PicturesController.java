package com.fh.controller.administrator.information.pictures;
...
public class PicturesController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("administrator/information/pictures/pictures_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("administrator/information/pictures/pictures_add");
			mv.addObject("pd", pd);
		} catch (Exception e) {
			logger.error(e.toString(), e);
		}						
	...
	public ModelAndView goEdit(){
		...
		try {
			...
			mv.setViewName("administrator/information/pictures/pictures_edit");
